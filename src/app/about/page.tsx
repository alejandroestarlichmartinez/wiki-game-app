...
export default async function About() {
  return (
    <div className='max-w-6xl mx-auto space-y-4 p-3'>
      ...
      <p>
        Welcome to our videogame database website! We are a team of passionate videogame
        enthusiasts who have come together to create a one-stop destination for
        all your videogame-related needs.
      </p>

      <p>
        Our website is designed to provide you with a comprehensive database of
        videogames from all around the world, along with the latest news, reviews,
        and trailers. Our videogame database is constantly updated with new
        releases, ensuring that you have access to the latest and greatest in
        the world of cinema. You can search for videogames by title, director,
        actor, genre, or release date, making it easy to find the perfect videogame
        for any occasion.
      </p>

      <p>
        In addition to our extensive videogame database, we also offer a platform
